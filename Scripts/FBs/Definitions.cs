...
public struct Vec3 : IFlatbufferObject
{
  ...
  public static Offset<XRMultiplayer.Vec3> CreateVec3(FlatBufferBuilder builder, float X, float Y, float Z) {
    builder.Prep(4, 12);
    builder.PutFloat(Z);
    builder.PutFloat(Y);
    builder.PutFloat(X);
    return new Offset<XRMultiplayer.Vec3>(builder.Offset);
  }
};
...
public struct Quat : IFlatbufferObject
{
  ...
  public static Offset<XRMultiplayer.Quat> CreateQuat(FlatBufferBuilder builder, float X, float Y, float Z, float W) {
    builder.Prep(4, 16);
    builder.PutFloat(W);
    builder.PutFloat(Z);
    builder.PutFloat(Y);
    builder.PutFloat(X);
    return new Offset<XRMultiplayer.Quat>(builder.Offset);
  }
};
...
public struct HandState : IFlatbufferObject
{
  ...
  public static Offset<XRMultiplayer.HandState> CreateHandState(FlatBufferBuilder builder, byte Pinky, byte Ring, byte Middle, byte Index, byte Thumb) {
    builder.Prep(1, 5);
    ...
    return new Offset<XRMultiplayer.HandState>(builder.Offset);
  }
};
