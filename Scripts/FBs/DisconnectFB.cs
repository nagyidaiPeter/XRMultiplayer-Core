...
public struct DisconnectFB : IFlatbufferObject
{
  ...
  public static Offset<XRMultiplayer.DisconnectFB> CreateDisconnectFB(FlatBufferBuilder builder,
      byte PlayerID = 0) {
  ...
  public static Offset<XRMultiplayer.DisconnectFB> EndDisconnectFB(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<XRMultiplayer.DisconnectFB>(o);
  }
  public static void FinishDisconnectFBBuffer(FlatBufferBuilder builder, Offset<XRMultiplayer.DisconnectFB> offset) { builder.Finish(offset.Value); }
  public static void FinishSizePrefixedDisconnectFBBuffer(FlatBufferBuilder builder, Offset<XRMultiplayer.DisconnectFB> offset) { builder.FinishSizePrefixed(offset.Value); }
};
